...
export const linuxPkgsToInstall = {
  apt: ['build-essential', 'cmake', 'ninja-build', 'ccache', 'cppcheck', 'gcovr', 'zlib1g-dev', 'libffi-dev', 'libssl-dev', 'libbz2-dev', 'libreadline-dev', 'libsqlite3-dev','gcc-aarch64-linux-gnu','g++-aarch64-linux-gnu', 'gcc-arm-linux-gnueabihf', 'g++-arm-linux-gnueabihf', 'libxml2-dev', 'libxslt1-dev', 'liblzma-dev', 'libncurses-dev', 'tk-dev'],
